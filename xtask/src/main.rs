...
impl BuildFlavor {
    ...
    fn zip_stem(self, version: &str) -> String {
        match self {
            Self::Lite => format!("Hybrid-Mount-{version}"),
...
mod tests {
    ...
    use super::{BuildFlavor, build_meta_shared, configure_flavor_config};
