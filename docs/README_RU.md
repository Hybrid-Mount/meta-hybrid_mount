...
- Поддерживаются arm64, armv7, x86_64 и riscv64; установщик автоматически выбирает подходящий бинарный файл. Для сборки riscv64 требуется Android NDK r27 или новее.
