...
- VFS требует совместимый K2, встроенный в ядро или установленный отдельно. До уточнения лицензии upstream релизы содержат исходный код K2, но не содержат скомпилированный модуль K2.
